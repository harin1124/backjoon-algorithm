...
/**
 * @title 알람 시계
 * @desc 상근이는 매일 아침 알람을 듣고 일어난다.<br>
		 알람을 듣고 바로 일어나면 다행이겠지만, 항상 조금만 더 자려는 마음 때문에 매일 학교를 지각하고 있다.<br>
		 ...
		 이 방법은 단순하다.<br>
		 원래 설정되어 있는 알람을 45분 앞서는 시간으로 바꾸는 것이다.<br>
 ...
 * @input 첫째 줄에 두 정수 H와 M이 주어진다.<br>
		  (0 ≤ H ≤ 23, 0 ≤ M ≤ 59) 그리고 이것은 현재 상근이가 설정한 놓은 알람 시간 H시 M분을 의미한다.<br>
		  입력 시간은 24시간 표현을 사용한다.<br>
		  24시간 표현에서 하루의 시작은 0:0(자정)이고, 끝은 23:59(다음날 자정 1분 전)이다.<br>
		  시간을 나타낼 때, 불필요한 0은 사용하지 않는다.
 * @output 첫째 줄에 상근이가 창영이의 방법을 사용할 때, 설정해야 하는 알람 시간을 출력한다.<br>
		   (입력과 같은 형태로 출력하면 된다.)
...
public class Problem2884 {
	...
	public static void main(String[] args) {
		...
		if(minutes-45 < 0){
			//System.out.println("hours 빼야 함");
			if(hours-1 < 0){
				//System.out.println("23시로 되돌아가야 함");
				hours = 23;
			}else{
				hours = hours - 1;
			}
