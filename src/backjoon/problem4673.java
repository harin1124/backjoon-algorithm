...
/**
 * @title 셀프 넘버
 * @desc 셀프 넘버는 1949년 인도 수학자 D.R. Kaprekar가 이름 붙였다.<br>
		 ...
		 n을 d(n)의 생성자라고 한다. 위의 수열에서 33은 39의 생성자이고, 39는 51의 생성자, 51은 57의 생성자이다.<br>
		 생성자가 한 개보다 많은 경우도 있다. 예를 들어, 101은 생성자가 2개(91과 100) 있다.<br> 
