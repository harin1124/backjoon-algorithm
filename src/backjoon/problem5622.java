...
/**
 * @title 다이얼
 * @desc 상근이의 할머니는 아래 그림과 같이 오래된 다이얼 전화기를 사용한다.<br>
         ...
         즉, 어떤 단어를 걸 때, 각 알파벳에 해당하는 숫자를 걸면 된다. 예를 들어, UNUCIC는 868242와 같다.<br>
 ...
 * @studyStartDate 2022-08-12
 * @studyEndDate 2022-08-12
 */
