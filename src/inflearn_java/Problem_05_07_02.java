...
public class Problem_05_07_02 {
    public static void main(String[] args) throws Exception {
        ...
        String result = "YES";
        for(char x : codeList.toCharArray()){
            if(essentialCodeQueue.contains(x)){
                if(x != essentialCodeQueue.poll()){
                    result = "NO";
                    break;
